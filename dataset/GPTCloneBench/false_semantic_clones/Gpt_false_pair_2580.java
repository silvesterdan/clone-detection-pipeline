static void test_02 () throws FileNotFoundException {
 ...
 static void test_02() throws FileNotFoundException { 
    ...
    scanner.close(); 
    final int rounds = 400; 
    int[] sortedArray = new int[houseLocations.length]; 
    System.arraycopy(houseLocations, 0, sortedArray, 0, houseLocations.length); 
    Arrays.sort(sortedArray); 
    int[] uniqueHouseLocationsSorted = findUnique(sortedArray); 
    final int transmitterRange = 73381; 
    final long start = System.currentTimeMillis(); 
