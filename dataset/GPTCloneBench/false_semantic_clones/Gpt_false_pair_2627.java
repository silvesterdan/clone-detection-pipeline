public static void main (String [] args) throws IOException {
 ...
 public static void main(String [] args) throws IOException{
    File dir = new File("switchFolder");
    String source = dir.getCanonicalPath() + File.separator + "masterList.txt";
    String dest = dir.getCanonicalPath() + File.separator + "listCopy.txt";
