...
Border lineBorder = new LineBorder (new Color (255, 0, 0), 15);
Border threePartBorder = new CompoundBorder (lineBorder, new BevelBorder (BevelBorder.RAISED, Color.BLUE, Color.YELLOW));
l.setBorder (threePartBorder);
JFrame f = new JFrame("Three Part Border");
f.setDefaultCloseOperation (JFrame.DISPOSE_ON_CLOSE);
f.setContentPane (l);
