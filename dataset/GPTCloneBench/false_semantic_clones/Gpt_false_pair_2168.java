public static void main (String [] args) throws Exception {
 ...
 public static void main (String [] args) throws Exception {KeyPairGenerator hostKeyGen = KeyPairGenerator.getInstance("ECDH"); 
    ...
    KeyPair hostKey = hostKeyGen.generateKeyPair(); 
    System.out.println("Initiating host side Schannel");
    KeyAgreement schannel = KeyAgreement.getInstance("ECDH");
    schannel.init(hostKey.getPrivate());
}
