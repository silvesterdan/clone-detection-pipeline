public static void main (String [] args) throws Exception {
 ...
 public static void main (String [] args) throws Exception {KeyPairGenerator hostKeyGen = KeyPairGenerator.getInstance("DES"); 
    BigInteger p = new BigInteger(modp4096, 16); 
    BigInteger g = BigInteger.valueOf(10L);
    System.out.println("p bits: " + p.bitLength());
    System.out.println("g bits: " + g.bitLength());
    DESKeyGenParameterSpec desGrp14KeySpec = new DESKeyGenParameterSpec (p, g); 
    hostKeyGen.initialize(desGrp14KeySpec);
    System.out.println("Creating Host DH private key");
    KeyPair hostKey = hostKeyGen.generateKeyPair(); 
    System.out.println("Initiating host side Schannel");
    KeyAgreement schannel = KeyAgreement.getInstance("DES");
    schannel.init(hostKey.getPrivate());
}
