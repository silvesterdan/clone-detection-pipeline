public void start (Stage primaryStage) {
 ...
 public void start (Stage primaryStage) {double y1 = 15;
   ...
   hb1.getChildren ().addAll (new Label ("ProgressBar 1"), p1);
   double y2 = 15;
   ProgressBar p2 = new ProgressBar ();
   p2.setLayoutY (y2);
   HBox hb2 = new HBox (10);
   hb2.getChildren ().addAll (new Label ("ProgressBar 2"), p2);
   double y3 = 15;
   ProgressBar p3 = new ProgressBar ();
   p3.setLayoutY (y3);
   HBox hb3 = new HBox (10);
   hb3.getChildren ().addAll (new Label ("ProgressBar 3"), p3);
   ListViewChooser listViewChooser = new ListViewChooser (hb1, hb2, hb3);
   listViewChooser.setStyle ("-fx-font: 10px \"Verdana\";");
   VBox root = new VBox ();
   root.getChildren ().add (listViewChooser);
   Scene scene = new Scene (root, 300, 250);
   primaryStage.setTitle ("Hello World!");
   primaryStage.setScene (scene);
   primaryStage.show ();
