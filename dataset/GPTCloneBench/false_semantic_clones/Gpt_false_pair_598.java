public static void main (String [] args) {
 ...
 public static void main (String [] args) {
    ...
    //receieve the index from the user 
    int position = sc.nextInt ();
    //create the pointer for the index
    String [] tempReference = arr [position - 1];
    //shift the index from the received index
    for (int k=position - 1 ; k < arr.length - 1 ; k++) {
        arr [k] = arr [k + 1];
    }
