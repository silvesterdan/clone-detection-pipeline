public void draw (Graphics2D g) {
  ...
  public void draw (Graphics2D g) {float arrowRatio = 0.4f;
    ...
    path.quadTo (waistX, - waistY, endX, 0.0f);
    path.quadTo (waistX, waistY, veeX - arrowLength, arrowWidth);
    path.lineTo (veeX - arrowLength * 0.8f, 0.0f);
    path.lineTo (veeX - arrowLength, - arrowWidth);
    g.setColor (Color.YELLOW);
    g.fill (path);
    g.setColor (Color.ORANGE);
    g.draw (new Line2D.Float (30.0f, 0.0f, veeX - arrowLength * 0.4f, 0.0f));
}
