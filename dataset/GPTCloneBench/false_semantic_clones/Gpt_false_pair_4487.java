...
public static void main (String [] args) {
    List < Animal > list1 = new LinkedList < > (Arrays.asList (Cat, Dog, Mouse));
    List < Animal > list2 = new LinkedList < > (Arrays.asList (Mouse, Dog, Cat));
    List < Animal > list3 = new LinkedList < > (Arrays.asList (Horse, Cat, Dog));
    List < Animal > list4 = new LinkedList < > (Arrays.asList (Tiger, Lion, Dog));
    List < List < Animal > > list = new LinkedList < > (Arrays.asList (list1, list2, list3, list4));
    Set < List < Animal > > sorted = new LinkedHashSet < > ();
    for (List < Animal > animals : list) {
        List < Animal > arList = new ArrayList < > (animals);
