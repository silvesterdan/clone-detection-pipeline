...
public void propertyChange (PropertyChangeEvent pce) { 
    if (MVC_Model.PERCENTCHANGE.equals (pce.getPropertyName ())) { 
        view.setProgress ((Integer) pce.getNewValue ()); 
     }
     if (MVC_Model.PERCENTCHANGE1.equals (pce.getPropertyName ())) { 
        view.setProgressLabel ((String) pce.getNewValue ()); 
     }
     if (MVC_Model.PERCENTCHANGE2.equals (pce.getPropertyName ())) { 
        view.setIconLabel ((Icon) pce.getNewValue ());
     }
}
