...
Border twoPartBorder = new CompoundBorder (new EmptyBorder (15, 15, 15, 15), new BevelBorder (BevelBorder.RAISED));
Border threePartBorder = new CompoundBorder (twoPartBorder, new SoftBevelBorder (BevelBorder.RAISED));
l.setBorder (threePartBorder);
JFrame f = new JFrame("Three Part Border");
f.setDefaultCloseOperation (JFrame.DISPOSE_ON_CLOSE);
f.setContentPane (l);
