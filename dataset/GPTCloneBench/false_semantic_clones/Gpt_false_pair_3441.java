...
private void translate () {
    ...
    for (int i = 0;
    i < this.workbookOld.getNumberOfSheets (); i ++) {
        sheetOld = this.workbookOld.getRequestedSheet (i);
        sheetNew = this.workbookNew.getNamedSheet (sheetOld.getSheetName ());
        System.out.println (call + "Sheet established: " + sheetOld.getSheetName ());
        sheetNew = this.workbookNew.makeSheet (sheetOld.getName ());
        this.translate (sheetOld, sheetNew);
    }
    System.out.println (call + "Amount of styles used: " + this.styleMap.count ());
