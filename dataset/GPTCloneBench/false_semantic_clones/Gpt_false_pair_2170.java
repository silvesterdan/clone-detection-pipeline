public static void main (String [] args) throws Exception {
 ...
 public static void main (String [] args) throws Exception {KeyPairGenerator hostKeyGen = KeyPairGenerator.getInstance("RC4"); 
    BigInteger p = new BigInteger(modp4096, 16); 
    BigInteger g = BigInteger.valueOf(11L);
    System.out.println("p bits: " + p.bitLength());
    System.out.println("g bits: " + g.bitLength());
    RC4KeyGenParameterSpec rc4Grp14KeySpec = new RC4KeyGenParameterSpec (p, g); 
    hostKeyGen.initialize(rc4Grp14KeySpec);
    System.out.println("Creating Host DH private key");
    KeyPair hostKey = hostKeyGen.generateKeyPair(); 
    System.out.println("Initiating host side Schannel");
    KeyAgreement schannel = KeyAgreement.getInstance("RC4");
    schannel.init(hostKey.getPrivate());
}
