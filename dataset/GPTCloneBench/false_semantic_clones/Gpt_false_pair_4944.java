...
public static void main (String [] args) {
    ...
    for (long i = 1;
    i <= 1000; i ++) {
        sum510 += Math.pow (i, i) % fiveTo10;
        sum510 %= fiveTo10;
    }
    long tenTo10 = 10_000_000_000L;
    long answer = sum210 * modInverse (fiveTo10, twoTo10) * fiveTo10 + sum510 * modInverse (twoTo10, fiveTo10) * twoTo10;
    answer %= tenTo10;
    System.out.println (answer);
}
