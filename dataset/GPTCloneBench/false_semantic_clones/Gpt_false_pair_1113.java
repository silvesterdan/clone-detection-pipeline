public static void main (String...args) {
  ...
  public static void main (String...args) {
    processor = new DefaultProcessor ();
    double [] values = new double [] {0.0, 4.0, 10.0, 12.0, 100.0, 108.0, 299.0, 1000.0, 1003.0, 2040.0, 45213.0, 100000.0, 100005.0, 100010.0, 202020.0, 202022.0, 999999.0, 1000000.0, 1000001.0, 10000000.0, 10000007.0, 99999999.0, Long.MAX_VALUE, Long.MIN_VALUE};
    String [] strValues = new String [] {"0", "1.30", "0001.00", "3.141592"};
