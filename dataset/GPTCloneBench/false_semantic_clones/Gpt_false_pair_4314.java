...
public Fluid addFluid () {
    ...
    do {
        try {
            if (! alreadyAnswered1) {
                System.out.println ("Please enter fluids description: ");
                f.setFluidDescription (input.next ());
                alreadyAnswered1 = true;
            }
            if (! alreadyAnswered2) {
                System.out.println ("Please enter fluids solubility: ");
                f.setSolubility (input.nextDouble ());
                alreadyAnswered2 = true;
            }
            if (! alreadyAnswered3) {
                System.out.println ("Please enter fluids flash point: ");
                f.setFlashPoint (input.nextDouble ());
                alreadyAnswered3 = true;
            }
            error = false;
        } catch (InputMismatchException e) {
