...
public static void main(String[] args)
{
	int[] A = {9, 5, 4, 3, 2, 1, 34, 53};
    	int divider = 4;
    	int count_low = 0; // Count for Low array 
    	int count_high = 0; // Count for High array 
    	...
    	int[] low = new int[count_low]; // Create Low array
    	int[] high = new int[count_high]; // Create High array
