...
public void actionPerformed (ActionEvent e) {
    ImageIcon widthIcon = new ImageIcon ("gameIcon.png");
    String scaleWidth = (String) JOptionPane.showInputDialog (null, "What is the player's score?", "", JOptionPane.QUESTION_MESSAGE, widthIcon, null, null);
    ImageIcon heightIcon = new ImageIcon ("platformer.png");
    String scaleHeight = (String) JOptionPane.showInputDialog (null, "What level is the player on?", "", JOptionPane.QUESTION_MESSAGE, widthIcon, null, null);
    double x = Double.parseDouble (scaleWidth);
    double y = Double.parseDouble (scaleHeight);
    int newWidth = (int) x;
    int newHeight = (int) y;
