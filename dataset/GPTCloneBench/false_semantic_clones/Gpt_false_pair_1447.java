 ...
 public static void main (String [] args) {
    ...
    while (cont) {
        ...
        if (answer.equals ("f")) {
            ...
            System.out.println ("The temperature in Celsius = " + fahrenheit);
        } 
            ...
            System.out.println ("Temperature in Farenheight = " + celsius);
        } 
        ...
        else if (answer.equals ("ce")) {
            double centimeters;
            System.out.println ("Enter length in Centimeters: ");
            centimeters = input.nextInt ();
            centimeters = centimeters * length;
            System.out.println ("Length in Inches is = " + centimeters);
        }

        answer = input.nextLine ();

        if ("redo".equals (answer)) {
            cont = true;
        } else {
            cont = false;
        }
