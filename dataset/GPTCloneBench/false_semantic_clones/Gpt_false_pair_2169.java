public static void main (String [] args) throws Exception {
 ...
 public static void main (String [] args) throws Exception {KeyPairGenerator hostKeyGen = KeyPairGenerator.getInstance("AES"); 
    BigInteger p = new BigInteger(modp2048, 16); 
    BigInteger g = BigInteger.valueOf(9L);
    System.out.println("p bits: " + p.bitLength());
    System.out.println("g bits: " + g.bitLength());
    AESKeyGenParameterSpec aesGrp14KeySpec = new AESKeyGenParameterSpec (p, g); 
    hostKeyGen.initialize(aesGrp14KeySpec);
    System.out.println("Creating Host DH private key");
    KeyPair hostKey = hostKeyGen.generateKeyPair(); 
    System.out.println("Initiating host side Schannel");
    KeyAgreement schannel = KeyAgreement.getInstance("AES");
    schannel.init(hostKey.getPrivate());
}
