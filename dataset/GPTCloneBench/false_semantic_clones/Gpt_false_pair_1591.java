public void propertyChange (PropertyChangeEvent pce) {
 ...
 public void propertyChange(PropertyChangeEvent pce) {
    if (MVC_Model.PROGRESS.equals(pce.getPropertyName())) {
        view.updateProgressBarValue((Integer)pce.getNewValue());
    }
    if (MVC_Model.PROGRESS1.equals(pce.getPropertyName())) {
        view.updateProgressLableText((String)pce.getNewValue());
    }
    if (MVC_Model.PROGRESS2.equals(pce.getPropertyName())) {
        view.updateProgressIconImage((Icon)pce.getNewValue());
    }
}
