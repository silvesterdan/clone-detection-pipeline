public static void main (String...args) {
 ...
 public static void main(String[] args) {
    processor = new DefaultProcessor();
    long[] values = {1, 4, 10, 12, 100, 108, 299, 1000, 1003, 2040, 45213, 100000, 100005, 100010, 202020, 202022, 999999, 1000000, 1000001, 10000000, 10000007, 99999999, Long.MAX_VALUE, Long.MIN_VALUE};
