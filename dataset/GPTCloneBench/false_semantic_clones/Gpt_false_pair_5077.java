...
public static void main (String...args) {
    ...
    String [] strValues = new String [] {"0", "1.30", "0001.00", "3.141592"};
    for (long val : values) {
        System.out.println (processor.getName (val) + " = " + val);
    }
    for (String strVal : strValues) {
        System.out.println (processor.getName (strVal) + " = " + strVal);
    }
    StringBuilder bigNumber = new StringBuilder ();
    for (int d = 0;
    d < 66; d ++) {
    ...
    System.out.println (processor.getName (bigNumber.toString ()) + " = " + bigNumber.toString ());
}
