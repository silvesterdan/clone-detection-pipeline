...
public static void main (String...args) {
    ...
    for (int i = 0;
    i < MAX_VAL; i ++) {
        linkedList.add (MAX_VAL / 3, i);
    }
    System.out.println ("LL time:\t" + (System.nanoTime () - time));
    time = System.nanoTime ();
    for (int i = 0;
    i < MAX_VAL; i ++) {
        arrayList.add (MAX_VAL / 3, i);
    }
    System.out.println ("AL time:\t" + (System.nanoTime () - time));
    linkedList = new LinkedList < Integer > ();
    arrayList = new ArrayList < Integer > ();
    ...
    time = System.nanoTime ();
    ListIterator < Integer > li = linkedList.listIterator (MAX_VAL / 3);
    for (int i = 0;
    i < MAX_VAL; i ++) {
        li.add (i);
    }
    System.out.println ("LL iterator:\t" + (System.nanoTime () - time));
    time = System.nanoTime ();
    ListIterator < Integer > ali = arrayList.listIterator (MAX_VAL / 3);
    for (int i = 0;
    i < MAX_VAL; i ++) {
        ali.add (i);
    }
