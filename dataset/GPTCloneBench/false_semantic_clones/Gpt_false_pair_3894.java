...
public void run_Type3 () {
    try {
        ...
        changeBtnMargin (new Insets (initMargin.top, initMargin.left + 15, initMargin.bottom, initMargin.right - 15));
        border = new EmptyBorder (0, 10, 10, 10);
        changePnlBorder (border);
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left - 15, initMargin.bottom, initMargin.right + 15));
        border = new EmptyBorder (0, 0, 10, 10);
        ...
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left - 15, initMargin.bottom, initMargin.right + 15));
        border = new EmptyBorder (10, 10, 5, 5);
        changePnlBorder (border);
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left, initMargin.bottom, initMargin.right));
        border = new EmptyBorder (5, 5, 10, 10);
        changePnlBorder (border);
        Thread.sleep (100);
        count ++;
    } catch (Exception e) {
