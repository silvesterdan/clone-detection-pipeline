...
public static void main (String [] args) {
    try {
        ArrayList<String> sentences = null;
        sentences = new ArrayList<String>();
        sentences.add("John and Jane are my classmates.");
        sentences.add("John and Jane are my classmates.");
        sentences.add("Jane and John are my classmates.");
        sentences.add("Ed and Ella are not my classmates.");
        sentences.add("Some completely different sentence.");
        wordAnalyser(sentences);
    } catch (Exception e) {
        e.printStackTrace();
    }
