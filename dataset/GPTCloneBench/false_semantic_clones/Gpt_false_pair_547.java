public void start (Stage primaryStage) {
 ...
 public void start (Stage primaryStage) {double y1 = 15;
   ...
   p1.setLayoutY (y1);
   HBox vb1 = new HBox (10);
   vb1.getChildren ().addAll (new Label ("ProgressIndicator 1"), p1);
   double y2 = 15;
   ProgressIndicator p2 = new ProgressIndicator ();
   p2.setLayoutY (y2);
   HBox vb2 = new HBox (10);
   vb2.getChildren ().addAll (new Label ("ProgressIndicator 2"), p2);
   double y3 = 15;
   ProgressIndicator p3 = new ProgressIndicator ();
   p3.setLayoutY (y3);
   HBox vb3 = new HBox (10);
   vb3.getChildren ().addAll (new Label ("ProgressIndicator 3"), p3);
   TextChooser textChooser = new TextChooser (vb1, vb2, vb3);
   textChooser.setStyle ("-fx-font: 10px \"Verdana\";");
   StackPane root = new StackPane ();
   root.getChildren ().add (textChooser);
