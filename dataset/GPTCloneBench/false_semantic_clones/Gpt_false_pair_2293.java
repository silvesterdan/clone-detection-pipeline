public static void main (String [] args) {
 ...
 public static void main (String [] args) {
    Scanner scan = new Scanner (System.in);
    int itemsNumber = 0;
    System.out.print ("What is The Aggregate of Goods: ");
    try {
        itemsNumber = Integer.parseInt (scan.nextLine ().trim ());
    } catch (NumberFormatException e) {
        System.out.print ("Number of items you entered is invalid!");
        System.exit (0);
    }
    Grocery grocery = new Grocery (itemsNumber);
    for (int i = 0;
    i < itemsNumber; i ++) {
        System.out.print ("Input Product " + (i + 1) + " : ");
        if (! grocery.addItem (scan.nextLine ())) {
