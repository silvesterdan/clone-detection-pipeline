...
public static void main (String [] args) {
    ...
    for (long i = 1;
    i <= 1000; i ++) {
        sum510 += modPow (i, i, fiveTo10);
        sum510 %= fiveTo10;
    }
    long tenTo10 = 10_000_000_000L;
    long answer = sum210 * modularInverse (fiveTo10, twoTo10) * fiveTo10 + sum510 * modularInverse (twoTo10, fiveTo10) * twoTo10;
    answer %= tenTo10;
    System.out.println (answer);
}
