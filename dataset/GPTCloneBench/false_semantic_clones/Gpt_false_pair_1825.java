public static void main (String...args) {
 ...
 public static void main (String...args) {
    ...
    System.out.println("LL Cycle time:\t" + (System.nanoTime() - time));
    time = System.nanoTime();
    for (int i = 0; i < MAX_VAL; i++) {
        arrayList.add(MAX_VAL / 2, i);
    }
    System.out.println("AL Cycle time:\t" + (System.nanoTime() - time));
    linkedList = new LinkedList < Integer > ();
    arrayList = new ArrayList < Integer > ();
    for (int i = 0; i < MAX_VAL; i ++) {
        linkedList.add(i);
    ...
    System.out.println("LL Iterator time:\t" + (System.nanoTime() - time));
    time = System.nanoTime();
    ListIterator < Integer > ali = arrayList.listIterator (MAX_VAL / 2);
    for (int i = 0; i < MAX_VAL; i ++) {
        ali.add(i);
    }
    System.out.println("AL Iterator time:\t" + (System.nanoTime() - time));
} 
