    ...
    while (number > 0) {
        switch (number % 10) {
            ...
            case 5 :
                ...
                break;
            case 6 :
                asRomanNumerals = RN [i] + RN [i + 1] + RN [i] + asRomanNumerals;
                break;
            case 7 :
                asRomanNumerals = RN [i] + RN [i + 1] + RN [i] +RN [i] + asRomanNumerals;
                break;
            case 8 :
                asRomanNumerals = RN [i] + RN [i + 1] + RN [i] + RN [i] + RN [i] + asRomanNumerals;
                break;
            case 9 :
                asRomanNumerals = RN [i] + RN [i + 2] + asRomanNumerals;
                break;
