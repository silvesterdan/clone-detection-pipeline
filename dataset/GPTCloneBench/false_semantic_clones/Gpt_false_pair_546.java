public void start (Stage primaryStage) {
 ...
 public void start (Stage primaryStage) {double y1 = 15;
   ...
   fp1.getChildren ().addAll (new Label ("ProgressBar 1"), p1);
   double y2 = 15;
   ProgressBar p2 = new ProgressBar ();
   p2.setLayoutY (y2);
   FlowPane fp2 = new FlowPane ();
   fp2.getChildren ().addAll (new Label ("ProgressBar 2"), p2);
   double y3 = 15;
   ProgressBar p3 = new ProgressBar ();
   p3.setLayoutY (y3);
   FlowPane fp3 = new FlowPane ();
   fp3.getChildren ().addAll (new Label ("ProgressBar 3"), p3);
   TextChooser textChooser = new TextChooser (fp1, fp2, fp3);
   textChooser.setStyle ("-fx-font: 10px \"Verdana\";");
