  ...
  public static void main (String [] args) {
    ...
    year < 2001; year ++) {
        ...
        month < calendar.length; month ++) {
            ...
            while (daysToSunday < 8 && dayOfMonth < daysInMonth) {
                System.out.println ("year: " + year + "\tday: " + daysToSunday + "\tcalendar[" + month + "][" + dayOfMonth + "]: " + calendar [month] [dayOfMonth]);
                if (daysToSunday == 7 && year > 1900) {
                    calendar [month] [dayOfMonth] ++;
                    if (dayOfMonth == 0) {
                        numOfSundays ++;
                    }
