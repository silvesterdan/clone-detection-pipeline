...
public void run_Type4 () {
    try {
        ...
        changeBtnMargin (new Insets (initMargin.top, initMargin.left + 20, initMargin.bottom, initMargin.right - 20));
        ...
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left + 20, initMargin.bottom, initMargin.right - 20));
        border = new EmptyBorder (15, 10, 0, 0);
        changePnlBorder (border);
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left - 20, initMargin.bottom, initMargin.right + 20));
        border = new EmptyBorder (10, 10, 10, 5);
        changePnlBorder (border);
        Thread.sleep (100);
        changeBtnMargin (new Insets (initMargin.top, initMargin.left, initMargin.bottom, initMargin.right));
