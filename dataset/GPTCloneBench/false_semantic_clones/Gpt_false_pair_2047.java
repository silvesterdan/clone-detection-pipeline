public void draw (Graphics2D g) {
 ...
 public void draw (Graphics2D g) { float arrowRatio = 0.7f;
    ...
    path.quadTo (waistX, - waistY, endX, 0.0f);
    path.quadTo (waistX, waistY, veeX - arrowLength, arrowWidth);
    path.lineTo (veeX - arrowLength * 0.6f, 0.0f);
    path.lineTo (veeX - arrowLength, - arrowWidth);
    g.setColor (Color.GREEN);
    g.fill (path);
    g.setColor (Color.RED);
    g.draw (new Line2D.Float (20.0f, 0.0f, veeX - arrowLength * 0.2f, 0.0f));
}
