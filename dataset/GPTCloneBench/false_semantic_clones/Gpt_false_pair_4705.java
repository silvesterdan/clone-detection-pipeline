...
public static void main (String [] args) {
    ...
    while (cont) {
        System.out.println ("Pick an option and its corresponding letter to select.");
        System.out.println ("Gallons to Liters: g");
        System.out.println ("Liters to Gallons: l");
        System.out.println ("Inches to Centimeters: i");
        System.out.println ("Centimeters to Inches: ce");
        System.out.println ("");
        System.out.println ("Make your choice: ");
        ...
        if (choice.equals ("g")) {
            ...
            System.out.println ("Volume in Liters = " + gallons);
        } else if (choice.equals ("l")) {
            float liters;
            System.out.println ("Enter volume in Liters: ");
            liters = input.nextInt ();
            liters = (liters / 3.78541);
            System.out.println ("Volume in Gallons = " + liters);
        } else if (choice.equals ("i")) {
            double inches;
            System.out.println ("Enter length in Inches: ");
            inches = input.nextInt ();
